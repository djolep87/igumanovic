...
@section('title', 'Креирање Oбогаћеног једносменског рада Сеча Река')
...
<div class="col-12 grid-margin stretch-card" id="container">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="/admin.obogaceni_seca_reka.store" method="POST" enctype="multipart/form-data">
            @csrf
