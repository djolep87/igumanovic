...
@section('title', 'Измена Oбогаћеног једносменског рада Косјерић')
...
<div class="col-12 grid-margin stretch-card" id="container">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="/admin.obogaceni_kosjeric/{{$post->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
