                      ...
                      <tbody>
                        @foreach ($posts as $post)
                         <tr>
                            ...
                            <td>
                             <a href="/admin.nasi_radovi.show/{{$post->id}}"><i class="fa fa-eye" style="font-size:20px"></i></a>
                             <a href="/admin.nasi_radovi.edit/{{$post->id}}"><i class="fa fa-edit" style="font-size:20px"></i></a>
                             <form action="/admin.nasi_radovi.destroy/{{ $post->id }}" id="myform" method="POST">
                              @csrf
                              @method('DELETE')
